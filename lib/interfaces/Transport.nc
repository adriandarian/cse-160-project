...
interface Transport{
   ...
   command char* getUsername(socket_t fd);
   command uint16_t getDestinationFromSocketId(socket_t fd);
   command uint16_t getDestinationFromSocketUsername(char *username);
